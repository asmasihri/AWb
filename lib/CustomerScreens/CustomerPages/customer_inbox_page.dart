...
class CustomerInboxPage extends StatefulWidget {
  @override
  State<CustomerInboxPage> createState() => _CustomerInboxPageState();
}

class _CustomerInboxPageState extends State<CustomerInboxPage> {
              ...
              child: ListView.separated(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                    onTap: () {
                      setState(() {
                        Navigator.pushNamed(context, CustomerChatScreen.id);
