...
class SellerProfilPage extends StatefulWidget {
  const SellerProfilPage({Key? key}) : super(key: key);

  @override
  _SellerProfilPageState createState() => _SellerProfilPageState();
}

class _SellerProfilPageState extends State<SellerProfilPage> {
  @override
