...
class SellerAcceptedDetailsScreen extends StatefulWidget {
  const SellerAcceptedDetailsScreen({Key? key}) : super(key: key);
  static const String id = 'Seller_accepteddetails_screen';

  @override
  State<SellerAcceptedDetailsScreen> createState() =>
      _SellerAcceptedDetailsScreenState();
}

class _SellerAcceptedDetailsScreenState
    extends State<SellerAcceptedDetailsScreen> {
  @override
