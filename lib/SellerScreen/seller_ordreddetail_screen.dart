...
class SellerOrdredDetailsScreen extends StatefulWidget {
  const SellerOrdredDetailsScreen({Key? key}) : super(key: key);
  static const String id = 'Seller_ordreddetails_screen';

  @override
  State<SellerOrdredDetailsScreen> createState() =>
      _SellerOrdredDetailsScreenState();
}

class _SellerOrdredDetailsScreenState extends State<SellerOrdredDetailsScreen> {
  @override
